                    ...
                    <tr>
                        ...
                        <td><!-- Button trigger modal -->
                            ...
                            <button type="button" class="btn btn-outline-warning btn-sm" data-toggle="modal"
                                    data-target="#modelId{{ $category->id }}">
                                Update
                            </button>

                            <!-- Modal -->
                            <div class="modal fade" id="modelId{{ $category->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="modelTitleId">Update {{ $category->category }}</h4>
                                        </div>
                        ...
                        <td><a id="deletebtn" class="btn btn-outline-danger btn-sm" href="deleteCategory/{{ $category->id }}" role="button">Delete</a></td>
                    </tr>
                    @endforeach
                    </tbody>
                </table>
